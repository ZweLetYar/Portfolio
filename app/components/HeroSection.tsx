...
function HeroSection() {
  return (
    <div className="h-90  flex w-[80%]">
      <div className="w-1/2 flex flex-col items-center justify-center gap-5 hero-container">
        ...
        <div className="flex gap-4 items-center justify-center text-sm btn-group">
